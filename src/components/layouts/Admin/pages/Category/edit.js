...
const EditCategory = () => {
    ...
    const fetchApi = async () => {
        try {
            const response = await fetch(`http://https://backend-shoptech.onrender.com//admin/list-category/edit/${idCategory.id}`);
    ...
    const onFinish = async (values) => {
        ...
        try {
            const res = await fetch(`http://https://backend-shoptech.onrender.com//admin/list-category/edit/${idCategory.id}`, {
                method: "PATCH",
                headers: {
